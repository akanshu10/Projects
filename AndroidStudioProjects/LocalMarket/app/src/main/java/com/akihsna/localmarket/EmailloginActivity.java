   ...
   // FirebaseAuth mauth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
               ...
               /* mauth.signInWithEmailAndPassword(email.getText().toString(),lpass.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(mauth.getCurrentUser().isEmailVerified()){
                            startActivity(new Intent(com.akihsna.chandokmarket.EmailloginActivity.this,loginhomepageActivity.class));
                            finish();
                        }else{
                            Toast.makeText(com.akihsna.chandokmarket.EmailloginActivity.this,task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                        }
                        }else{
                            Toast.makeText(com.akihsna.chandokmarket.EmailloginActivity.this,"Please enter correct email or password",Toast.LENGTH_SHORT).show();
                        }
                    }*/
        ...
        text2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.akihsna.localmarket.EmailloginActivity.this,forgetpasswordActivity.class));
                finish();
