...
public class TracterActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tracter2);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Token-number/Trolly");
