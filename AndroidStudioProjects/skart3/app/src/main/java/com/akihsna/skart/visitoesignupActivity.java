...
public class visitoesignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visitor_signup);
        mfullname = findViewById(R.id.fullName);
        muserEmailId = findViewById(R.id.userEmailId);
        mnxt=findViewById(R.id.nextBtn);
        ...
        //  startActivity(new Intent(getApplicationContext(), MainActivity.classs));
        //finish();
